...
class HttpOverDidcommApi(object):
    ...
    def register_http_msg_svc(self, **kwargs):  # noqa: E501
        """register_http_msg_svc  # noqa: E501

        registers new http over didcomm service to message handler registrar  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.register_http_msg_svc(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param RegisterHTTPMsgSvcArgs params: Params for registering http over did comm message service.
        ...
        if kwargs.get('async_req'):
            return self.register_http_msg_svc_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.register_http_msg_svc_with_http_info(**kwargs)  # noqa: E501
            return data

    def register_http_msg_svc_with_http_info(self, **kwargs):  # noqa: E501
        """register_http_msg_svc  # noqa: E501

        registers new http over didcomm service to message handler registrar  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.register_http_msg_svc_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method register_http_msg_svc" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/http-over-didcomm/register', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
